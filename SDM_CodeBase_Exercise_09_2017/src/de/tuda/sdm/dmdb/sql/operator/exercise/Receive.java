...
public class Receive extends ReceiveBase {
	...
	public void open() {
		...
		Queue<AbstractRecord> localCache = null;
		AtomicInteger finishedPeers = new AtomicInteger(numPeers-1);
		try {
			TCPServer self = new TCPServer(listenerPort,localCache,finishedPeers);
		} catch (IOException e) {
